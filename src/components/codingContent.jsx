      ...
      <section>
        <ol className="justify-between flex flex-col">
          {projects.map((project, index) => (
            <li
              key={index}
              className="flex flex-col lg:grid lg:grid-cols-4 lg:border-2 lg:border-neutral-300  lg:pt-4 lg:my-5"
            >
              <a
                href={project.link}
                target="_blank"
              ...
              >
                <img
                  ...
                  className="h-auto w-full border-2 lg:border-neutral-300  object-contain  lg:my-2 lg:border-0"
                />
              </a>
              <div className="lg:col-span-1 lg:my-4 lg:py-8">
                ...
                <a
                  href={project.link}
                  target="_blank"
                  className="mt-4 block w-full border-2 lg:border-neutral-300  px-4 py-2 text-center text-xl lg:mt-0 lg:px-0 lg:py-2 hover:bg-ykbdark active:bg-ykb-light hover:text-neutral-100
                  "
                >
                  View Website
                </a>
                <a
                  ...
                  target="_blank"
                  className="mt-5 block w-full border-2 lg:border-neutral-300  px-4 text-center text-xl  lg:mt-0 lg:mt-3 lg:px-0 lg:py-2 hover:bg-ykbdark active:bg-ykb-light hover:text-neutral-100"
                >
                  View Github
                </a>
              </div>
              ...
              <div className="mx-auto my-4 h-10 border-8 border-dashed lg:border-neutral-300  lg:hidden"></div>
            </li>
          ))}
        </ol>
      </section>
