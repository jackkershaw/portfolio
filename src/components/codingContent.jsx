...
function CodingContent() {
  const projects = [
    ...
    },
    {
      title: "Typespotting",
      description:
        "Find the Cooper neutral-900 font in this Where's Wally-style game. Built using HTML, CSS, and JavaScript.",
            ...
            >
              ...
              >
                <img
                  ...
                  className="w-full h-auto border border-neutral-300 rounded-lg mb-2 lg:mb-0"
                />
              </a>
              ...
              <div className="lg:col-span-1 flex flex-row justify-center">
                <div className="hidden lg: pl-5">
                  <img
                    ...
                    className="rounded-lg border border-neutral-300 max-h-80"
                  />
                </div>
              </div>
            </li>
